...
{
    public class CartAddModel : BaseModel 
    {
        ...
        private Models.CartAddRequestModel shared;
        private List<Models.CartAddRequestModel> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.CartAddRequestModel Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.CartAddRequestModel> Request 
        { 
            get 
            {
                return this.request; 
