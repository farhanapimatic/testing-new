...
{
    public class CartGetModel : BaseModel 
    {
        ...
        private Models.CartGetRequestModel shared;
        private List<Models.CartGetRequestModel> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.CartGetRequestModel Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.CartGetRequestModel> Request 
        { 
            get 
            {
                return this.request; 
