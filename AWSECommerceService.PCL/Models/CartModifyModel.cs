...
{
    public class CartModifyModel : BaseModel 
    {
        ...
        private Models.CartModifyRequestModel shared;
        private List<Models.CartModifyRequestModel> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.CartModifyRequestModel Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.CartModifyRequestModel> Request 
        { 
            get 
            {
                return this.request; 
