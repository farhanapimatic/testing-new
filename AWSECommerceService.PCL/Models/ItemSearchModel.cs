...
{
    public class ItemSearchModel : BaseModel 
    {
        ...
        private Models.ItemSearchRequestModel shared;
        private List<Models.ItemSearchRequestModel> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.ItemSearchRequestModel Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.ItemSearchRequestModel> Request 
        { 
            get 
            {
                return this.request; 
