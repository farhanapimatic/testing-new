...
{
    public class CartCreateModel : BaseModel 
    {
        ...
        private Models.CartCreateRequestModel shared;
        private List<Models.CartCreateRequestModel> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.CartCreateRequestModel Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.CartCreateRequestModel> Request 
        { 
            get 
            {
                return this.request; 
