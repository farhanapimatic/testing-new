...
{
    public class CartClearModel : BaseModel 
    {
        ...
        private Models.CartClearRequestModel shared;
        private List<Models.CartClearRequestModel> request;
        ...
        /// </summary>
        [JsonProperty("Shared")]
        public Models.CartClearRequestModel Shared 
        { 
            get 
            {
                return this.shared; 
        ...
        public List<Models.CartClearRequestModel> Request 
        { 
            get 
            {
                return this.request; 
